...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'E-Receipt'),
    );
  }
}
          ...
          children: <Widget>[
            ...
            RaisedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => SecondRoute(title: _displayValue)),
                );
              },
              child: const Text(
                'Get Signature',
...
class SecondRoute extends StatefulWidget {
  ...
  final String title;
  @override
  _SecondRoute createState() => _SecondRoute(title);
}
            ...
            child: Container(
              child: Padding(
                ...
                child: Signature(
                  ...
                  backgroundPainter: _WatermarkPaint("2.0", "Test Name"),
                ...
                children: [
                  MaterialButton(
                      ...
                      onPressed: () async {
                        ...
                        // "923454022965"
                       await Share.file('Signature: ' + title, title + '_signature.png', data.buffer.asUint8List(), 'image/png', text: 'Signature: ' + title);
                        setState(() {
                          _img = data;
                        });
